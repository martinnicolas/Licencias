...
public class AgentesJPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        agente.setDni(Integer.parseInt(this.dni.getText().trim()));
        agente.setApellido(this.apellido.getText().trim());
        agente.setNombre(this.nombre.getText().trim());
        LicenciasPUEntityManager = javax.persistence.Persistence.createEntityManagerFactory("LicenciasPU").createEntityManager();
        LicenciasPUEntityManager.getTransaction().begin();
        LicenciasPUEntityManager.persist(agente);
        LicenciasPUEntityManager.getTransaction().commit();
        LicenciasPUEntityManager.close();
